...
"  call Decho("exe silent r! nm -a --demangle -- ".shellescape(b:libfile,1))
  exe "silent r! nm -a --demangle -- ".shellescape(b:libfile,1)
  if v:shell_error != 0
   silent %d
   redraw!
